import pandas as pd
import numpy as np
from separate_year_15min_intervals import matrix_2015, matrix_2016, matrix_2017, matrix_2018, matrix_2019, matrix_2020
...
df_hot.to_csv(r'analysis based on 15mins intervals\hottest_time_15mins.csv')  # out put as csv file
...
df_cold.to_csv(r'analysis based on 15mins intervals\coldest_time_15mins.csv')  # out put as csv file
