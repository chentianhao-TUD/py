...
# set values for columns 'Produkt_Code','SDO_ID','Qualitaet_Niveau',\
# 'Qualitaet_Byte', they are the same as the input values
...
# the last 3 values are not included here, because of the missing data from 26.Feb 2020
...
# assume the max.value of matrix.shape[0]=a, then Y[k]=(Y[a-1]-Y[a-2])*(X[k]/60)+Y[a-2],X[k]=75,90,105
